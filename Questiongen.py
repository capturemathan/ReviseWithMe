    ...
    try:
        ...
        for sentence in txt.sentences:
            ...
            if all(key in bucket for key in p1):
                question = 'Who' + ' ' + \
                    sentence.words[bucket['VBZ']] + ' ' + \
                    sentence.words[bucket['NNP']] + '?'
                ...
                question = 'How' + ' ' + \
                    sentence.words[bucket['NN']] + ' ' + \
                    sentence.words[bucket['VBN']] + '?'

            elif all(key in bucket for key in h2):
                question = 'How' + ' ' + \
                    sentence.words[bucket['NN']] + ' ' + \
                    sentence.words[bucket['VBD']] + '?'
                ...
                question = 'How' + ' ' + 'many ' + \
                    sentence.words[bucket['NNS']] + '?'

            elif all(key in bucket for key in l1):
                question = 'What' + ' ' + \
                    sentence.words[bucket['VBZ']] + ' ' + sentence.words[bucket['NNP']
                                                                         ] + ' ' + sentence.words[bucket['VBG']] + '?'
                ...
                question = 'What' + ' ' + \
                    sentence.words[bucket['VBZ']] + ' ' + sentence.words[bucket['PRP']
                                                                         ] + ' ' + sentence.words[bucket['VBG']] + '?'

            elif all(key in bucket for key in l4):
                question = 'What ' + sentence.words[bucket['PRP']] + ' ' + ' does ' + \
                    sentence.words[bucket['VBG']] + ' ' + \
                    sentence.words[bucket['VBG']] + '?'

            elif all(key in bucket for key in l5):
                question = 'What' + ' ' + \
                    sentence.words[bucket['VBZ']] + ' ' + sentence.words[bucket['NN']
                                                                         ] + ' ' + sentence.words[bucket['VBG']] + '?'
                ...
                if sentence.words[bucket['PRP']] in ['she', 'he']:
                    question = 'What' + ' does ' + sentence.words[bucket['PRP']].lower(
                    ) + ' ' + sentence.words[bucket['VBZ']].singularize() + '?'
